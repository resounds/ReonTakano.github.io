...
- **Scene 1: Persona & Career (自己紹介と経歴)**
  - 明るく軽やかなパーティクル背景。
  - 趣味（テニス、旅行、音楽など）や、これまでの職務経歴・インターン・活動実績を「自身の歩み」としてビジュアル重視で紹介。
...
- **Scene 3: Archive (実績/知の集積)**
  ...
  - 学歴、Publications (論文・発表)、受賞履歴を整理して表示。
...
- `profile.ts`: 基本プロフィール、趣味など
- `career.ts`: 職務経歴、インターン、活動実績
